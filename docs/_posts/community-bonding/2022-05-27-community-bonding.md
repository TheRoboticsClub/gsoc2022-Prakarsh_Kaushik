...
#### RotorS
- RotorS is a MAV gazebo simulator(Micro Aerial Vehicle (MAV) simulation framework). It provides some multi-rotor helicopter models such as the AscTec Hummingbird, Pelican, and Firefly, but the simulator is not limited for use with these multicopters.
...
> *Reference* [2](https://www.researchgate.net/publication/309291237_RotorS_-_A_Modular_Gazebo_MAV_Simulator_Framework)

![Structure of the packages](/assets/blog-images/community-bonding/rotors_pkg_struct.png)

#### TUM sim (melodic & noetic)
...
#### MRS gazebo simulation(melodic & noetic)
...
- #### [PR#1](https://github.com/JdeRobot/RoboticsAcademy/pull/1759) solves issue [#1](https://github.com/JdeRobot/RoboticsAcademy/issues/1758)
